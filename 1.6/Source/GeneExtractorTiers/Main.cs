...
namespace GeneExtractorTiers
{
    ...
    internal class GeneExtractorMain : Mod
    {
        ...
        private string extractionBuff, multipakBuff, megaPackBuff, splitZeroCost, geneRegrowBuff, nutritionUse;
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            listStd.TextFieldNumericLabeled("GET_SplitZeroCostChance".Translate(), ref settings.splitZeroCost, ref splitZeroCost, min: 0.0f, max: 1.0f);
            ...
            listStd.CheckboxLabeled("GET_AllVatsCanTargetGenes".Translate(), ref settings.allVatsCanTargetGenes);
            listStd.End();
    ...
    public class ExtractorTierSettings: ModSettings
    {
        ...
        public float multipackChance = 0.40f;
        public float megaMultipackChance = 0.10f;
        public float splitZeroCost = 1f;
        public float genesRegrowingHours = -1f;
        public float nutritionMultiplier = 1f;
        public bool allVatsCanTargetGenes = false;
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref multipackChance, "multipackChance", 0.40f);
            Scribe_Values.Look(ref megaMultipackChance, "megaMultipackChance", 0.10f);
            Scribe_Values.Look(ref splitZeroCost, "splitZeroCost", 1f);
            ...
            Scribe_Values.Look(ref allVatsCanTargetGenes, "allVatsCanTargetGenes", false);
            base.ExposeData();
        }
    }
}
